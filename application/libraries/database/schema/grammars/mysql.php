<?php namespace Database\Schema\Grammars;
...
class MySQL extends Grammar  {
    ...
    {
        if (in_array($column->type, array('integer','tinyint','smallint','mediumint','int','bigint')) and $column->increment)
        {
     ...
     * @return string
     */
    protected function type_year(Fluent $column)
    {
        return 'YEAR';
    }

    /**
     * Generate the data-type definition for an tiny integer.
     *
     * @param  Fluent  $column
     * @return string
     */
    ...
    /**
     * Generate the data-type definition for an small integer.
     *
     * @param  Fluent  $column
     * @return string
     */
    protected function type_smallint(Fluent $column)
    {
        return 'SMALLINT('.$column->length.')';
    }

    /**
     * Generate the data-type definition for an medium integer.
     *
     * @param  Fluent  $column
     * @return string
     */
    protected function type_mediumint(Fluent $column)
    {
     ...
     * @return string
     */
    protected function type_int(Fluent $column)
    {
        return 'INT('.$column->length.')';
    }

    /**
     * Generate the data-type definition for an big integer.
     *
     * @param  Fluent  $column
     * @return string
     */
    protected function type_bigint(Fluent $column)
    {
        return 'BIGINT('.$column->length.')';
    }

    /**
     * Generate the data-type definition for an char.
     *
     * @param  Fluent  $column
     * @return string
     */
     ...
     * @return string
     */
    protected function type_varchar(Fluent $column)
    {
        return 'VARCHAR('.$column->length.')';
    }
}