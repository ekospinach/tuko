...
class Paginator {
     ...
     * @var string
     */
    protected $dots = '<li class="disabled"><a href="" onclick="return false">...</a></li>';


    public static $full_tag_open        = '<div class="pagination"><ul>';
    public static $full_tag_close       = '</ul></div>';

    public static $next_link            = 'Next';
    public static $prev_link            = 'Prev';
    ...
    public static $cur_tag_open         = '<li class="disabled active">';
